...
tooltip11 = "Click for more info! "
tooltip12 = "Click for more info! "
# icon marker
...
# geo marker
folium.GeoJson(geoOverlay,
               tooltip=tooltip10, 
               name='Kosutnjak Forest').add_to(m),

# markers
folium.Marker([44.818374, 20.465204],
              popup="Boem Street",
              tooltip=tooltip11,
              icon=folium.Icon(color="green")).add_to(m)

folium.Marker([44.816772, 20.460537],
              popup="National Theatre",
              tooltip=tooltip12,
              icon=folium.Icon(color="blue")).add_to(m)
